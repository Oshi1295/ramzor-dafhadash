...
try:
    ...
    st.markdown("💡 **תשובה זו הינה בגדר המלצה , נא לפנות לבעל מקצוע או לעמותת דף חדש**")
    client = None
...
with st.sidebar:
    ...
    st.markdown("💡 **תשובה זו הינה בגדר המלצה , נא לפנות לבעל מקצוע או לעמותת דף חדש**") עובד בהצלחה!")
